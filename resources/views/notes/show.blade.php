                ...
                @if(!$note->trashed())
                    ...
                    <form action="{{ route('notes.destroy', $note) }}" method="post">
                        ...
                        <button type="submit" class="btn btn-danger ml-4"
                                onclick="return confirm('Are you sure you wish to move this to trash?')">Move to Trash
                        </button>
                    </form>
                @else
                    <p class="opacity-70">
                    ...
                    <form action="{{ route('trashed.destroy', $note) }}" method="post">
                        ...
                        <button type="submit" class="btn btn-danger ml-4"
                                onclick="return confirm('Are you sure you wish to delete this note forever?  This action can not be undone.')">
                            Delete Forever
                        </button>
                    </form>
                @endif
